...
class VanillaVAE2D(BaseVAE):
    ...
    def reparameterize(self, mu: Tensor, logvar: Tensor) -> Tensor:
        ...
        N(0,1).
        :param mu: (Tensor) Mean of the latent Gaussian [B x D x H' x W']
        :param logvar: (Tensor) Standard deviation of the latent Gaussian [B x D x H' x W']
        :return: (Tensor) [B x D x H' x W']
        """
